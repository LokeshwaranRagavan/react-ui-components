/**
 * Radar Column Series Renderer
 * Renders column series in radar coordinate systems using arc-based rectangular shapes.
 *
 * @private
 */
...
const render: (series: SeriesProperties, _isInverted: boolean) => RenderOptions[] | {
    ...
    for (const point of visiblePoints) {
        ...
        startAngleDeg = finalAngle - singleSeriesAngle / 2;
        ...
        const pathD: string = generateRadarColumnPath(
            finalAngle,
            singleSeriesAngle / 2,
            innerRadius,
            outerRadius,
 ...
 * Radar Column Series Renderer
 */
const RadarColumnSeriesRenderer: {
...
export default RadarColumnSeriesRenderer;
