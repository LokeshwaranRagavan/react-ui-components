/**
 * Polar Scatter Series Renderer
 * Renders scatter series in polar coordinate systems using markers at transformed coordinates.
 *
 * @private
 */
...
import { Points, RenderOptions, SeriesProperties, MarkerProperties } from '../../chart-area/chart-interfaces';
...
/**
 * Renders a polar scatter series by placing markers at each data point's polar coordinates.
 *
...
const render: (
    ...
    for (const point of visiblePoints) {
        ...
        // Set marker location at polar point
        point.symbolLocations = [{
        ...
        // Apply point customization callback for color and styling
    ...
    // Create invisible anchor path for SeriesRenderer to track series index
    ...
    const markerOptions: ChartMarkerProps =  MarkerRenderer.render(series) as Object;
 ...
 * Polar Scatter Series Renderer
 */
const PolarScatterSeriesRenderer: {
    render: (
        series: SeriesProperties,
        _isInverted: boolean
    ) => RenderOptions[] | { options: RenderOptions[]; marker: MarkerProperties };
...
export default PolarScatterSeriesRenderer;
