/**
 * Polar Stacking Column Series Renderer
 * Renders stacking column series in polar coordinate systems with arc-based rectangles.
 *
 * @private
 */
...
/**
 * Generates the SVG path for a polar stacking column segment.
 ...
 * @returns {string} The SVG path string for the polar stacking column.
 */
...
const render: (
    ...
    for (const point of visiblePoints) {
        ...
        /*
         *  Compute stacked start & end values
         * using visibleSeries render order
         */
        ...
        //  Category‑based angle (correct for polar)
 ...
 * Polar Stacking Column Series Renderer
 */
const PolarStackingColumnSeriesRenderer: {
    render: (
        series: SeriesProperties,
        _isInverted: boolean
    ) => RenderOptions[] | { options: RenderOptions[]; marker: ChartMarkerProps };
...
export default PolarStackingColumnSeriesRenderer;
