/**
 * Radar Range Column Series Renderer
 * Renders range column series in radar coordinate systems using high/low values with arc-based rectangles.
 *
 * @private
 */
...
/**
 * Generates the SVG path for a radar range column segment.
 ...
 * @returns {string} The SVG path string for the radar range column.
 */
 ...
 * Radar Range Column Series Renderer
 */
const RadarRangeColumnSeriesRenderer: {
...
export default RadarRangeColumnSeriesRenderer;
