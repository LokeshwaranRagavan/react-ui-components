...
import { IFetch } from '@syncfusion/react-base';
...
export class UrlAdaptor extends Adaptor {
     ...
     * @returns void
     */
    public beforeSend(dm: DataManager, request: Request, settings?: IFetch): void {
...
export class ODataAdaptor extends UrlAdaptor {
     ...
     */
    public processResponse(
        data: DataResult, ds?: DataOptions, query?: Query, xhr?: Request, request?: IFetch, changes?: CrudOptions): Object {
    ...
    protected processBatchResponse(
        data: DataResult, query?: Query, xhr?: Request, request?: IFetch, changes?: CrudOptions): CrudOptions | DataResult {
...
export class RemoteSaveAdaptor extends JsonAdaptor {
    ...
    public processResponse(
        data: CrudOptions, ds?: DataOptions, query?: Query, xhr?: Request, request?: IFetch, changes?: CrudOptions, e?: RemoteArgs):
        Object {
        let i: number;
...
export class CacheAdaptor extends UrlAdaptor {
     ...
     */
    public processResponse(
        data: DataResult, ds?: DataManager, query?: Query, xhr?: Request, request?: IFetch, changes?: CrudOptions): DataResult {
